...
const darkStore = inject('darkStore');
const toggleDarkMode = () => {
    darkStore.isDarkMode = !darkStore.isDarkMode;
    localStorage.setItem('darkMode', darkStore.isDarkMode);
...
<template>
    <span class="inline-flex rounded-md">
        <button @click="toggleDarkMode"
            ...
            <svg v-if="darkStore.isDarkMode" style="width:24px;height:24px" viewBox="0 0 24 24">
            ...
            <svg v-else xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-sun" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
